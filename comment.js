...
//
    ...
    function generateSectionComment ( width ) {
        ...
        // line 2
        result +=
            indentationText + " " + startingLineChars + " " + text + " " + tailingLineChars + ""
...
//
    ...
    function generateReverseSectionComments ( width ) {
        ...
        // line 1
        let result =
            languageCommentSignSettings.chars.start

        // line 2
        result +=
            indentationText + " " + tailingLineChars + " " + text + " " + startingLineChars

        // line 3
        result +=
            languageCommentSignSettings.chars.end
...
//
    ...
    function generateCommentBasedOnIndentation ( kind ) {
        ...
        switch ( relativeIndentationSize ) {
            case 0:
                comment = sectionCommentGenerator( 60 )
                break
            case 1:
                comment = sectionCommentGenerator( 60 )
                break
